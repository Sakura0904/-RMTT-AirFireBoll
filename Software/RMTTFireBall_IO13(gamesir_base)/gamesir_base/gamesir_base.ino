...
/**********************************************************修改参数设置**************************************/
#define THROWING_SERVO_ANGLE 10
#define READY_SERVO_ANGLE 100
#define THROWING_RC_KEY (data.L2 || data.R2)
#define READY_RC_KEY (data.L1 || data.R1)
/************************************************************************************************/
...
void user_task(void *arg)
{
  while (1)
  {
    ...
    if (THROWING_RC_KEY)
    {
      servo_13.write(THROWING_SERVO_ANGLE);
    }
    else if (READY_RC_KEY)
    {
      servo_13.write(READY_SERVO_ANGLE);
    }

//    else if (data.A)
//    {
//      tt_sdk.SetMdirection(0);
//      tt_sdk.SetMon();
//
//      tt_sdk.Go(int(0), int(0), int(80), int(30),"m1");
//    }
    /* Put your code here ! */
